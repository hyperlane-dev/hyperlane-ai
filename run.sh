...
# 7. Upload the model and dataset to the Hugging Face Hub
echo "Uploading the model and dataset to the Hugging Face Hub..."
python upload_to_hub.py
echo "Model and dataset uploaded successfully!"
